...
(define (pantalla e) (cond
                       [(null? e) (rectangle ANCHO ALTO "solid" COLOR-FONDO)]
                       [else (place-image (circle RADIO "solid" COLOR) (posn-x (first e)) (posn-y (first e)) (pantalla (rest e)))]
                       ))
...
(define (key-handler e k) (cond
                            [(string=? k " ") (cons (make-posn (+ (random (- ANCHO (* 2 RADIO))) RADIO) (+ (random (- ALTO (* 2 RADIO))) RADIO)) e)]
                            [(string=? k "b") INIT]
                            [(string=? k "u") (rest e)]
                            [else e]
                            ))
